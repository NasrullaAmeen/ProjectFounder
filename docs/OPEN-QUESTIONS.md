...
| Q4 | P2 research recommendations ("actions not phases" wording for the Workflow Engine § 20; a retrospective/feedback lifecycle step) — not addressed by D007 (that covered P1 only). | `open` | Nothing yet |
